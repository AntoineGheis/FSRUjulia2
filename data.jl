...
import_at = Dict(
    ...
    "SI" => 0.0, "ES" => 0.0, "SE" => 0.0, "XX" => 12.9190, "CH"=>0.0, "LI"=>0.0
)
...
import_bg = Dict(
    ...
    "SI" => 0.0, "ES" => 0.0, "SE" => 0.0, "RU" => 1.205349, "US" => 0.3886, "AZ" => 0.55, "TR" =>0.0, "XX"=>0.0, "MK" =>0.0, "RS" =>0.0
...
import_hr = Dict(
    ...
    "MT" => 0.0, "NL" => 0.0, "PL" => 0.0, "PT" => 0.0, "RO" => 0.0, "SK" => 0.0, 
    "SI" => 0.386551, "ES" => 0.0, "SE" => 0.0, "EG" => 0.285451, "US" => 2.121875, "QA" => 0.091, "NG" =>0.015696, "US" => 2.121875, "TT" => 0.012148,"QA" => 0.091301, "RS" =>0.0, "BA" =>0.0,  "ME" =>0.0, "XX" =>0.0
)
...
import_de =Dict(  "AT" => 12.0, "BE" => 10.0, "BG" => 0.0, "HR" => 0.0, "CY" => 0.0, "CZ" => 0.0, "CH" => 0.0,
    ...
    "SI" => 0.0, "ES" => 0.0, "SE" => 0.0, "RU" => 25.941, "NO" =>27.690345, "NotSpec" => 34.063124,"XX" => 0.0) 
...
import_ee = Dict(
    ...
    "MT" => 0.0, "NL" => 0.0, "PL" => 0.0, "PT" => 0.0, "RO" => 0.0, "SK" => 0.0, 
    "SI" => 0.0, "ES" => 0.0, "SE" => 0.0, "RU" =>0.0,"XX"=>0.0
)
...
import_gr = Dict(
    ...
    "HU" => 0.0, "IE" => 0.0, "IT" => 0.0, "LV" => 0.0, "LT" => 0.0, "LU" => 0.0, 
    "MT" => 0.0, "NL" => 0.0, "PL" => 0.0, "PT" => 0.0, "RO" => 0.0, "SK" => 0.0, 
    "SI" => 0.0, "ES" => 0.038995, "SE" => 0.0058, "RU" => 1.0, "NO" => 0.190687, "TR" => 0.220744, "CM" => 0.05871, "DZ" => 0.478791, "EG" => 0.445394, "NG" => 0.255058, "US" => 1.858949, "AZ" => 1.133814,"OM" => 0.88517, "MK"=>0.0, "AL"=>0.0
)
...
import_fi = Dict(
    ...
    "HU" => 0.0, "IE" => 0.0, "IT" => 0.0, "LV" => 0.0, "LT" => 0.0, "LU" => 0.0, 
    "MT" => 0.0, "NL" => 0.0, "PL" => 0.0, "PT" => 0.0, "RO" => 0.0, "SK" => 0.0, 
    "SI" => 0.0, "ES" => 0.0, "SE" => 0.0, "RU" =>0.677, "EG" =>0.02, "NO" =>0.0
)
import_fr = Dict(
...
import_it = Dict(
    ...
    "SI" => 0.022753, "ES" => 0.918329, "SE" => 0.0, "RU" => 13.987589, "NO" => 6.214956, "DZ" => 25.92301, "EG" => 0.906481, "LY" => 3.120008, "NG" =>0.185003, "US" => 3.003934, "TT" => 0.221122, "AZ" => 10.325,"QA" => 7.288852, "XX" => 0.0, "SM"=>0.0, "VA"=>0.0
)
...
import_lv = Dict(
    ...
    "MT" => 0.0, "NL" => 0.0, "PL" => 0.0, "PT" => 0.0, "RO" => 0.0, "SK" => 0.0, 
    "SI" => 0.0, "ES" => 0.0, "SE" => 0.0, "RU" => 0.189, "BY"=>0.0
)
...
import_lt = Dict(
    ...
    "HU" => 0.0, "IE" => 0.0, "IT" => 0.0, "LV" => 0.0, "LT" => 0.0, "LU" => 0.0, 
    "MT" => 0.0, "NL" => 0.0, "PL" => 0.0, "PT" => 0.0, "RO" => 0.0, "SK" => 0.0, 
    "SI" => 0.0, "ES" => 0.0, "SE" => 0.0, "RU" => 0.279, "NO" => 0.8948, "US" => 2.37, "BY"=>0.0, "XX"=>0.0
)
...
import_hu = Dict(
    ...
    "HU" => 0.0, "IE" => 0.0, "IT" => 0.0, "LV" => 0.0, "LT" => 0.0, "LU" => 0.0, 
    "MT" => 0.0, "NL" => 0.0, "PL" => 0.0, "PT" => 0.0, "RO" => 0.0, "SK" => 0.0, 
    "SI" => 0.0, "ES" => 0.0, "SE" => 0.0, "RU" => 7.671, "NotSpec" => 1.643, "XX"=>0.0, "UA"=>0.0, "RS"=>0.0
)
...
import_nl = Dict(
    ...
    "HU" => 0.0, "IE" => 0.0, "IT" => 0.0, "LV" => 0.0, "LT" => 0.0, "LU" => 0.0, 
    "MT" => 0.0, "NL" => 0.0, "PL" => 0.0, "PT" => 0.0, "RO" => 0.0, "SK" => 0.0, 
    "SI" => 0.0, "ES" => 1.866299, "SE" => 0.0, "RU" => 6.376349, "NO" =>9.311929, "NotSpec" => 0.262638, "AO" =>2.673264, "CM" =>0.507399, "GQ" => 0.286443, "DZ" => 0.120687, "EG" => 0.786916, "NG" => 0.21084, "US" => 8.576669, "TT" => 0.939592,"QA" => 0.388523, "XX" =>0.0
)
...
import_pl = Dict(
    ...
    "MT" => 0.0, "NL" => 0.0, "PL" => 0.0, "PT" => 0.0, "RO" => 0.0, "SK" => 0.0, 
    "SI" => 0.0, "ES" => 0.0, "SE" => 0.0, "RU" => 2.9863, "EG" => 0.091324, "NG" => 0.178842, "US" => 3.434586, "TT" => 0.100681,"QA" => 2.300273, "UA"=>0.0, "BY"=>0.0
)
...
import_ro = Dict(
    ...
    "SI" => 0.0, "ES" => 0.0, "SE" => 0.0, "RU" =>0.365493, "UA" =>0.0, "MD"=>0.0, "RS"=>0.0, "XX"=>0.0
)
...
import_sk = Dict(
    ...
    "HU" => 0.0, "IE" => 0.0, "IT" => 0.0, "LV" => 0.0, "LT" => 0.0, "LU" => 0.0,
    "MT" => 0.0, "NL" => 0.0, "PL" => 0.0, "PT" => 0.0, "RO" => 0.0, "SK" => 0.0,
    "SI" => 0.0, "ES" => 0.0, "SE" => 0.0, "RU" =>2.388, "XX" => 3.803, "UA"=>0.0
)
...
country_price_cz = Dict("DE" => price_hh, "PL" => price_hh, "SK" => price_hh, "AT" => price_hh, "NotSpec" => price_hh, "RU" => price_hh, "NO" => price_hh, "CH" => price_hh,"ES" =>price_hh)

country_price_hr = Dict("SI" => price_hh, "HU" => price_hh, "EG" => price_hh, "US" => price_hh, "QA" => price_hh, "NG" => price_hh, "US" => price_hh, "TT" => price_hh,"QA" => price_hh, "BE" => price_hh, "CH" => price_hh, "RS" =>price_hh, "BA" =>price_hh,  "ME" =>price_hh, "XX" => price_hh)

country_price_de =  Dict("BE" => price_ttf, "AT" => price_hh, "NO" => price_hh, "CZ" => price_hh, "CH" => price_hh, "FR" => price_ttf, "PL" => price_hh, "DK" => price_hh, "NL" => price_ttf, "FI" => 0., "RU" => price_hh, "NotSpec" => price_hh, "CH" => price_hh, "XX" => price_hh)
...
country_price_fi = Dict("SE" => price_hh, "NO" => price_hh, "RU" => price_hh, "EG" => price_hh, "CH" => price_hh, "NO" =>price_hh)

country_price_fr = Dict("BE" => price_ttf, "LU" => price_ttf, "DE" => price_ttf, "CH" => price_ttf, "IT" => price_ttf, "ES" => price_ttf, "RU" => price_hh, "NO" => price_hh, "XX" => price_hh, "DZ" => price_hh, "NG" => price_hh, "US" => price_hh,"QA" => price_hh, "CH" => price_hh, "MK" => price_hh )
...
TOTAL_DEMAND_BE = range(25.1743, 0., length(2022:2050))[2:end]
...
export_BE = Dict("AT"=> 0.0, "BE"=> 0.0, "BG"=> 0.0, "CY"=> 0.0, "CZ"=> 0.0, "CH" => 0.0,
            ...
            "SI"=> 0.0, "SK"=> 0.0, "NO"=> 0.0, "CH"=>0.0, "LI" => 0.0, "XX" =>0.0)
...
export_BG = Dict("AT"=> 0.0, "BE"=> 0.0, "BG"=> 0.0, "CY"=> 0.0, "CZ"=> 0.0, "CH" => 0.0,
            ...
            "SI"=> 0.0, "SK"=> 0.0, "TR" =>0.0, "XX"=>0.0, "MK" =>0.0, "RS" =>0.0)
...
export_HR = Dict("AT"=> 0.0, "BE"=> 0.0, "BG"=> 0.0, "CY"=> 0.0, "CZ"=> 0.0, "CH" => 0.0,
            ...
            "IT"=> 0.0, "LT"=> 0.0, "LU"=> 0.0, "LV"=> 0.0, "MT"=> 0.0,
            "NL"=> 0.0, "PL"=> 0.0, "PT"=> 0.0, "RO"=> 0.0, "SE"=> 0.0,
            "SI"=> 0.0, "SK"=> 0.0, "RS" =>0.0, "BA" =>0.0,  "ME" =>0.0, "XX" => 0.0)
...
export_HU = Dict("AT"=> 0.0, "BE"=> 0.0, "BG"=> 0.0, "CY"=> 0.0, "CZ"=> 0.0, "CH" => 0.0,
            ...
            "SI"=> 0.0, "SK"=> 0.0, "XX"=>0.0, "UA"=>0.0, "RS"=>0.0)
...
export_IE = Dict("AT"=> 0.0, "BE"=> 0.0, "BG"=> 0.0, "CY"=> 0.0, "CZ"=> 0.0, "CH" => 0.0,
            ...
            "IT"=> 0.0, "LT"=> 0.0, "LU"=> 0.0, "LV"=> 0.0, "MT"=> 0.0,
            "NL"=> 0.0, "PL"=> 0.0, "PT"=> 0.0, "RO"=> 0.0, "SE"=> 0.0,
            "SI"=> 0.0, "SK"=> 0.0, "GB" =>0.0, "XX"=>0.0, "UK" =>0.0
)
...
export_IT = Dict("AT"=> 0.0, "BE"=> 0.0, "BG"=> 0.0, "CY"=> 0.0, "CZ"=> 0.0, "CH" => 0.0,
            ...
            "SI"=> 0.0, "SK"=> 0.0, "SM"=>0.0, "VA"=>0.0, "XX"=>0.0)
...
export_LT = Dict("AT"=> 0.0, "BE"=> 0.0, "BG"=> 0.0, "CY"=> 0.0, "CZ"=> 0.0, "CH" => 0.0,
            ...
            "SI"=> 0.0, "SK"=> 0.0,"BY"=>0.0, "XX"=>0.0, "RU" =>0.0)
...
export_RO = Dict("AT"=> 0.0, "BE"=> 0.0, "BG"=> 0.0, "CY"=> 0.0, "CZ"=> 0.0, "CH" => 0.0,
            ...
            "IT"=> 0.0, "LT"=> 0.0, "LU"=> 0.0, "LV"=> 0.0, "MT"=> 0.0,
            "NL"=> 0.0, "PL"=> 0.0, "PT"=> 0.0, "RO"=> 0.0, "SE"=> 0.0,
            "SI"=> 0.0, "SK"=> 0.0,"UA" =>0.0, "MD"=>0.0, "RS"=>0.0, "XX"=>0.0)
